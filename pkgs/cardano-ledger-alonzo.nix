...
, containers, data-default, deepseq, lib, measures, mtl, nothunks
, plutus-core, plutus-ledger-api, plutus-tx, prettyprinter
, serialise, small-steps, strict-containers, text, time
...
mkDerivation {
  ...
  libraryHaskellDepends = [
    ...
    cardano-slotting containers data-default deepseq measures mtl
    nothunks plutus-core plutus-ledger-api plutus-tx prettyprinter
    serialise small-steps strict-containers text time transformers
    utf8-string
  ];
